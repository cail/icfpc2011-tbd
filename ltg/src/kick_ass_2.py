...
class PrepBattery2(Bot):
    ...
    def mk_seq(self):
        ...
        sequence = []
        for t in [
            r'(\icomb. (K (icomb get batslot)) ((K (icomb help batslot batslot (icomb get pppslot))) (icomb attack batslot (icomb get obsslot) (icomb get ggeslot))))',
            ]:
...
class KickAss2(Bot):
    ...
    def recommend_pain(self):
        return self.game.proponent.vitalities[self.battery_slot] * 99 / 100
